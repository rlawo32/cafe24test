...
public class QMemberLog extends EntityPathBase<MemberLog> {
    ...
    private static final long serialVersionUID = 1415842592L;
    ...
    public final StringPath memberLogDate = createString("memberLogDate");

    public final StringPath memberLogIpAddress = createString("memberLogIpAddress");

    public final NumberPath<Long> memberLogNo = createNumber("memberLogNo", Long.class);

    public final StringPath memberLogSuccessYn = createString("memberLogSuccessYn");

    public final StringPath memberLogType = createString("memberLogType");
